...
Unsold tickets do not affect the launch time of the CasperArmyNFT pre-sale and incubation platform. Ticket sales will continue independently until the pool of discounted tickets is exhausted — Round 6 at the standard price is unlimited. Round 6 will have a minimum of 1,000 tickets but the final number will be decided by ticket holders from rounds 1-5 in a DAO vote.
