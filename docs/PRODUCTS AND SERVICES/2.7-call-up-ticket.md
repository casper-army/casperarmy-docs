...
Call-up NFT Ticket is a pass to CasperArmy’s platform tools. With the ticket you will be able, among other things, to easily create projects on the platform, and in combination with staking on our validator also invest in incubated projects and purchase a CasperArmy NFT to enjoy even more benefits.
...
- ### Allocations
Taking part in token purchases of incubated projects in the early seed round phase (place in line behind CasperArmyNFT holders)

- ### More points 
Each ticket has an algorithmically assigned number of points. Increase your points by buying more tickets. You can buy a maximum of 10 tickets

- ### CasperArmyNFT
Entitles you to receive the CasperArmyNFT Airdrop and participate in CasperArmyNFT sales rounds

- ### DAO Voting Rights
You have a decisive vote in matters related to the development of the CasperArmy platform and decisions related to the incubation of future projects on the platform — DAO Governance
...
CasperArmy tickets are available on the Casper and Binance Smart Chain networks.

### Why is the ticket also on the BSC network?

One of CasperArmy’s main goals is to promote the Casper network to users of other networks. In order to encourage investors using such networks as BSC or ETH, the creators of CasperArmy decided that the sale of tickets guaranteeing access to the CasperArmy platform and pre-sale of CasperArmyNFT will also take place on the popular network — Binance Smart Chain. Due to the emerging decentralized exchanges on the Casper network, we decided to allow users to buy tickets on the BSC network which is characterized by ease of use, wide availability and low transfer costs. However, we would like to point out that eventually, in the future, tickets purchased via the BSC network will be transferred to the Casper network — after the integration of user accounts via the CasperArmy.org platform.

Please note the actual CasperArmy NFT collection will be on the Casper Network, the ticket sale rounds only have the option to be purchased on either BSC or Casper Network.

### Why do I need a ticket and additionally stake CSPR?

It is important that reliable and active users of the CasperArmy community have access to the CasperArmy platform. The mechanism combining having a ticket and staking is one of several adopted mechanisms to check the credibility of the user and protects the platform from fake accounts and bots, which are often found on many platforms and aim to gain allocations in a fraudulent way. By limiting the access to the platform to dishonest people in this way, we ensure real allocations for real users.
...
You can learn more about the point system in the article under the heading “Community Points System”. Documents with details will be made available soon.
...
Information about the start of Round 1 ticket sales will appear on our official Twitter -> https://twitter.com/casperarmyorg and on CasperArmy’s social media channels i.e. Discord and Telegram.
...
To better understand the mechanism of the tickets, we recommend reviewing the points system under the heading “community points system”
